...
st.set_page_config(page_title="Twitter Data Visualization", layout="wide")
...
def selectLocAndAuth():
    ...
    lang = st.multiselect("Choose Author of tweets", list(df['original_author'].unique()))
...
def stBarChart():
    ...
    title = f"Top {num} Tweeps Ranking By Number of tweets"
